 ...
 */
public class LineIndexMapper extends Mapper<LongWritable, Text, Text, IndexMapRecordWritable> {
    ...
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        while (m.find()) {
            ...
            context.write(new Text(matchedKey), new IndexMapRecordWritable(key.get(),fileName));
